...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      ChargedLeptons lfs(FinalState((Cuts::abseta < 2.5 && Cuts::pT > 25*GeV && Cuts::abspid == PID::ELECTRON) || (Cuts::abseta < 2.4 && Cuts::pT > 20*GeV && Cuts::abspid == PID::MUON)));
      declare(lfs,"LFS");
      ...
      _h_bjet_pT = bookHisto1D("jetb_pT", logspace(40, 20.0, 300.0));
      _h_bjet_eta = bookHisto1D("jetb_eta", 50, -3.0, 3.0);
      _h_W_mass = bookHisto1D("W_mass", 20, 60, 100); 
      _h_t_mass = bookHisto1D("t_mass", 50, 0, 3000); 
      _h_t_pT = bookHisto1D("t_pT", logspace(25, 20, 500)); 
      ...
      _h_Z_mass = bookHisto1D("Z_mass", 20, 70, 110); 
      _h_quark1jet_pT = bookHisto1D("quark1jet_pT", logspace(25, 20.0, 350.0));
      _h_quark2jet_pT = bookHisto1D("quark2jet_pT", logspace(35, 30.0, 500.0));
      ...
      _h_alljets_pT = bookHisto1D("alljets_pT", logspace(35, 30.0, 500.0));
      _h_leadingbjet_mass = bookHisto1D("leadingbjet_mass", 20, 0, 100);
	}
    ...
    void analyze(const Event& event) {
      ...
      double z_mass_reco = (lepton.momentum() + lepton2.momentum()).mass();
